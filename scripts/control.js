...
(function() {
    ...
    * @protected
    */
    UI_CONTROL_CLASS.$resize = function(event) {
        //__gzip_original__el
    ...
    * by acelan
    */
    UI_CONTROL_CLASS.getPosition = function() {
        return dom.getPosition(this.getOuter());
    };
    /**
    * 获取控件的相对Y轴坐标。
    ...
    */
    ...
    //er ui
    UI_CONTROL_CLASS.__initOptions = function(options) {
